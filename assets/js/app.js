...
var _closePopup = _interopRequireDefault(require("./modules/close-popup"));
...
(function ($) {
  ...
  $(function () {
    ...
    if (typeof pre !== 'undefined' && pre != null) {
      var ps = new PerfectScrollbar(pre);
    }
  });
})(jQuery);

},{"./modules/burger-menu":3,"./modules/close-popup":4,"./modules/slider":5,"./modules/tabs":6,"./modules/timer":7,"./modules/video":8}],3:[function(require,module,exports){
"use strict";
...
var closePopup = function () {
  ...
  var closeInit = function closeInit() {
...
var swiperSlider = function () {
  var roadmapInit = new Swiper('.js-roadmap-slider', {
    enabled: true,
    slidesPerView: 'auto',
    spaceBetween: 0,
    speed: 800,
  ...
  var partnersInit = new Swiper('.js-partners-slider', {
    slidesPerView: 1,
    spaceBetween: 50,
    loop: true,
    speed: 800,
  ...
  var buildInit = new Swiper('.js-build-slider', {
    direction: 'vertical',
    slidesPerView: 7,
    loop: true,
    centeredSlides: true,
  ...
  var timerInit = function timerInit() {
    ...
    var initializeClock = function initializeClock(id, endtime) {
      ...
      var updateClock = function updateClock() {
        ...
        hoursSpan.innerHTML = "0".concat(t.hours).slice(-2);
        minutesSpan.innerHTML = "0".concat(t.minutes).slice(-2);
        secondsSpan.innerHTML = "0".concat(t.seconds).slice(-2);
    ...
    var deadline = 'December 31 2021'; // const deadline = new Date(Date.parse(new Date()) + 15 * 24 * 60 * 60 * 1000);
